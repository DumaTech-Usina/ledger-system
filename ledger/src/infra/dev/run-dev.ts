...
async function main(): Promise<void> {
  ...
  const app = createServer({ ledgerRepo, rejectedRepo, stagingRepo, positionService, usinaPartyId: "party-usina", cashPositionService, cashStatementService, cashListingService, readiness: async () => ({ database: true }), submitCandidate, serviceToken: process.env.LEDGER_SUBMIT_TOKEN ?? "" });
