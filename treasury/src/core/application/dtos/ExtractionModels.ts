 ...
 * `Candidate.occurredAt`, etc.) and so a result flows into `AdvanceDialogUseCase` with zero
 * conversion. Never import an OCR/parsing library's own types here — this file is the neutral
 * contract every adapter must translate into.
 */
